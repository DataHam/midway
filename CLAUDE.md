...
### Step 2: Persist Design System

To save for hierarchical retrieval:

```bash
python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" [--page "name"]
```

### Step 3: Domain & Stack Searches

| Need | Command |
|------|---------|
| Detailed Domain | `python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain>` |
| Stack Guide | `python3 .gemini/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack_name>` |
